...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (interactionText.gameObject.activeSelf)
        {
            ...
            interactionText.rectTransform.position = screenPos + new Vector3(offset.x * 1.25f, offset.y * 1.2f, 0f);
            bottomSprite.rectTransform.position = screenPos + offset - new Vector3(0, -5f * Screen.width / 1280f, 0);
        }
